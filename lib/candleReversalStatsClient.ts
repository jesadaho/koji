...
export type CandleReversalStatsRow = {
  ...
  /** play = เล่นปกติ · observe = เก็บ stats อย่างเดียว (R%<3 · Neutral · Strong Trend · Instant Pump · ไส้ล่าง>45% · Short+ATR%14D>25) */
...
export type CandleReversalStatsApiPayload = {
  ...
  /** เปิดเก็บ/แสดงตาราง Reversal 1D — จาก CANDLE_REVERSAL_1D_STATS_ENABLED */
  reversal1dStatsEnabled?: boolean;
