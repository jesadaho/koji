...
export const REVERSAL_MARKET_ENTRY_CANDIDATE_CRITERIA =
  `EMA20Δ15m < ${REVERSAL_MARKET_ENTRY_EMA20_15M_DIFF_MAX_PCT}% · Vol×SMA > ${REVERSAL_MARKET_ENTRY_VOL_VS_SMA_MIN} · Lower Wick < ${REVERSAL_MARKET_ENTRY_LOWER_WICK_MAX_PCT}% · ทิศ Short`;
