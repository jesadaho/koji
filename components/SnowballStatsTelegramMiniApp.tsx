...
const FOOTNOTE =
  "ทิศ = ทิศสัญญาณ Snowball · สวนทิศเทรด = Long->Short · Grade D = 1H confirm ไม่ผ่าน (ทิศ Long) · C (D) = ปรับเป็น C หลัง 4 ชม. · Binance USDT-M · RR ตาม SNOWBALL_STATS_RR_REWARD_SOURCE";
