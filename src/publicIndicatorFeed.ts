...
function buildSnowballTripleCheckMessage(
  ...
  args: {
    ...
    /** ผ่านเกณฑ์ Quality Signal (EMA4h > 10% · Funding > −0.10%) */
            ...
            try {
              if (!skipSnowballTgForPending) {
                ...
                await appendSnowballStatsRow({
                  ...
                  priceVsEma20_1hPct: longMktCtx?.priceVsEma20_1hPct ?? null,
                  ema20_1hSlopePct7d: longMktCtx?.ema20_1hSlopePct7d ?? null,
                  priceVsEma20_4hPct: longMktCtx?.priceVsEma20_4hPct ?? null,
                  ema20_4hSlopePct7d: longMktCtx?.ema20_4hSlopePct7d ?? null,
                  btcEma20_4hSlopePct7d: longMktCtx?.btcEma20_4hSlopePct7d ?? null,
            ...
            try {
              if (!skipBearTgForPending) {
                ...
                await appendSnowballStatsRow({
                  ...
                  priceVsEma20_1hPct: bearMktCtx?.priceVsEma20_1hPct ?? null,
                  ema20_1hSlopePct7d: bearMktCtx?.ema20_1hSlopePct7d ?? null,
                  priceVsEma20_4hPct: bearMktCtx?.priceVsEma20_4hPct ?? null,
                  ema20_4hSlopePct7d: bearMktCtx?.ema20_4hSlopePct7d ?? null,
                  btcEma20_4hSlopePct7d: bearMktCtx?.btcEma20_4hSlopePct7d ?? null,
